            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center">
                        <Link to="/" className="text-2xl font-bold text-black">DrivnBD</Link>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                        <Link to="/dashboard/cart" className="relative text-gray-500 hover:text-gray-700">
                        ...
                        {user ? (
                            ...
                            <Link
                                to="/login"
                                className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-900 hover:bg-gray-700"
                            >
                                Login
                            </Link>
                        )}
